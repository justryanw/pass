...
#[derive(Default)]
pub struct PasswordItemTemplate {
    name: Cell<String>,
    url: Cell<String>,
}

#[object_subclass]
impl ObjectSubclass for PasswordItemTemplate {
    const NAME: &'static str = "PasswordItem";
    type Type = super::PasswordItem;
}

impl ObjectImpl for PasswordItemTemplate {
    fn properties() -> &'static [ParamSpec] {
        static PROPERTIES: Lazy<Vec<ParamSpec>> = Lazy::new(|| {
            vec![
          ParamSpecString::new("name", "name", "The name of the RSS 
            password", Some(""), ParamFlags::READWRITE),
